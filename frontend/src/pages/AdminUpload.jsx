...
import YouListPanel from "../components/YouListPanel";
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 mt-2">Manage your Jiggasa content</p>
      </div>
      ...
      <section className="bg-white rounded-xl p-6 border border-gray-200">
        ...
        {/* Restrictions Notice */}
        <div className="my-2 bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-sm text-yellow-700">
          <p className="font-semibold mb-1">⚠️ Upload Restrictions:</p>
          <ul className="list-disc list-inside space-y-1">
            <li>
              Only <strong>PDF files</strong> are allowed.
            </li>
            <li>No images or other file formats are accepted.</li>
            <li>
              PDF must contain <strong>plain text</strong> — scanned/image-only

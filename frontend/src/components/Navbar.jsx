        ...
        <div className="flex items-center justify-between px-4 py-3">
          <Link to={"/"}>
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold">Jiggasa</h1>
            </div>
          </Link>

          <div className="hidden md:flex flex-col items-center  px-3 py-2 rounded-lg shadow-lg">
            <p className="text-sm font-semibold ">Md. Arafat Hossain</p>
            <p className="text-xs">
              ID: <span className="font-medium">232220</span>
            </p>
            <p className="text-xs  italic">IIT, Jahangirnagar University</p>
          </div>
